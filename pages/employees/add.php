        ...
        try {
            ...
            $stmt = $pdo->prepare("
                INSERT INTO employees (
                    employee_code, name, email, phone, department_id, shift_id, site_id,
